...
export function renderAdmin(container) {
    ...
    container.innerHTML = `
        <div class="space-y-6" style="padding:20px; color:white;">
            ...
            <div class="animate__animated animate__fadeInUp animate__faster space-y-10">
                ...
                <div style="display:flex; gap:15px; margin:20px 0;">
                    ...
                    <div class="stat-box" style="background:rgba(0,242,255,0.1); padding:15px; border-radius:12px; flex:1; border:1px solid #00f2ff;">
                        <small>VENCIMIENTOS</small>
                        <div id="val-exp" style="font-size:20px; color:#00f2ff; font-weight:bold;">0</div>
                    </div>
                </div>
                ...
                <h3 style="margin-top:30px; font-size:14px; color:#00f2ff; font-family:Orbitron;">BANDEJA DE SOPORTE</h3>
                <div style="background:rgba(255,255,255,0.02); padding:10px; border-radius:10px; margin-bottom:30px;">
                    ${(data.tickets || []).length > 0 ? data.tickets.map(t => `
                        <div style="border-bottom:1px solid rgba(255,255,255,0.05); padding:10px; font-size:12px;">
                            ...
                            ${t.status === 'Abierto' ? `
                                <button onclick="const r = prompt('Respuesta:'); if(r) app.quickReply(${t.id}, r)" style="background:#00f2ff; color:black; border:none; padding:3px 8px; border-radius:4px; cursor:pointer; font-weight:bold; font-size:10px;">RESPONDER</button>
                ...
                <h3 style="margin-top:30px; font-size:14px; color:#00f2ff;">CONTROL DE USUARIOS</h3>
                ...
                <div class="card" style="background:rgba(255,255,255,0.02); padding:20px; border-radius:15px; border:1px solid rgba(0,242,255,0.2); margin-top:30px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                        <h3 style="font-size:14px; color:#00f2ff;">INVENTARIO DE SERVICIOS</h3>
                        <div>
                            <button onclick="app.addService('streaming')" style="background:#00f2ff; color:black; border:none; padding:8px 12px; border-radius:8px; cursor:pointer; font-weight:bold; font-size:11px;">+ STREAMING</button>
